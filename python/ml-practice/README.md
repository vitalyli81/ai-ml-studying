...
| [pca/](pca/) | Part 10 (finale): eigendecomposition with np.linalg.eigh, cumsum/searchsorted, sign conventions, real datasets (iris, digits), and image compression as a JPEG slider | [ml/pca.md](../../ml/pca.md) |
