...
- **Evaluation & Monitoring** — LLM evaluation frameworks, observability
- **CI/CD for ML** — experiment tracking (MLflow, W&B), versioning
...
```
You are an expert technical educator creating a learning document on: "MLOps & Production"
