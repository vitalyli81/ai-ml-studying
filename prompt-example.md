...
Just paste this into Claude Code and replace `[REPLACE WITH TOPIC NAME]` at the bottom (e.g., "Retrieval-Augmented Generation (RAG)", "Transformer Architecture", "Vector Embeddings", "Fine-tuning vs RLHF").

**Pro tips for even better results:**

Add context about your level if the topic varies in complexity — e.g., "I already understand tokenization and embeddings" — so Claude Code doesn't over-explain basics you know.

For highly technical topics, append: "Include the key math, but always explain what each symbol means in plain English first."

For tooling/framework topics (like LangChain, LlamaIndex), append: "Focus on patterns over specific API syntax since APIs change frequently."

After generating, ask Claude Code to "review the doc and make the weakest 2 sections clearer" — this second pass often significantly improves quality.